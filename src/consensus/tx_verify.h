 ...
 * @param[in] coins Sorted (in input order) span of Coins containing previous transaction outputs tx is spending
 ...
 *
 * @param[in] coins Sorted (in input order) span of Coins containing previous transaction outputs we're spending
