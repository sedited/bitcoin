...
class BitcoinChainstateTest(BitcoinTestFramework):
    ...
    def writer_lock_test(self):
        ...
        expected_message = "Failed to create chainstate manager: Block tree store write lock is already held. Cannot have stores on multiple processes share write access."
